...
export const ScrollytellingHero = () => {
  ...
  const bgColor = useTransform(scrollYProgress, [0, 0.5, 1], ["#060a0e", "#111a24", "#0d1117"]);
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        {scrollProgress > 0.9 && (
          ...
          >
            ...
            <h2 className="font-display text-2xl md:text-3xl text-primary text-glow">The Twelve Signs Await</h2>
          </motion.div>
        )}
      </div>
    </div>
